    ...
    <section class="main">
      ...
      <div class="main-skills">
        <div class="card">
          ...
          <p style="font-weight: bold;  font-size: 15px;">Electricity Bill</p>
          <a href="electric-bill.html"><button>More Information</button></a>
        </div>
        
        
        <div class="card">
          <i class="fa-solid fa-water"></i> 
          <p style="font-weight: bold;  font-size: 15px;">Water Bill</p>
          <a href="water-bill.html"><button>More Information</button></a>
        </div>
        </div>
      </div>
    </section>      
